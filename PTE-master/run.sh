...
text_file=data/imdb/text_train.txt # the text file for training
label_file=data/imdb/label_train.txt # the label file for training
infer_file=data/imdb/text_all.txt # the text file to infer
output_path=workspace_imdb_big/
